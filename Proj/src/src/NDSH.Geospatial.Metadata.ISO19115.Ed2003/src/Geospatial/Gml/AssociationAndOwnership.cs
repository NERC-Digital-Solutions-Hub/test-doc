...
namespace NDSH.Geospatial.Gml {
  ...
  // WARNING: This has been implemented as an abstract class, but it may need to be changed into a concrete class. This depends on if the xxxPropertyTypes will be used or indtead the xxxTypes will be used with a property of type Association
  ...
  ///   </para>
  /// </remarks>
  [IsoType("AssociationAttributeGroup,OwnershipAttributeGroup", IsoType = IsoTypes.AttributeGroup)]
  public abstract class AssociationAndOwnership : AssociationEntity, IOwnership {
