...
//       element. multiPointProperty is the predefined property, which may be used by GML Application Schemas whenever a 
//       GML feature has a property with a value that is substitutable for MultiPoint.
//     </documentation>
//   </annotation>
// </element>
// ---------------------------------------------------------------------------------------------------------------------
...
namespace NDSH.Geospatial.Gml.Geometry.Aggregates {
  ...
  public class MultiPointPropertyType : ObservableModel {
    ...
    public MultiPointPropertyType() {
      _multiPoint = default; // new MultiPointType();
      _owns = false;
    }
