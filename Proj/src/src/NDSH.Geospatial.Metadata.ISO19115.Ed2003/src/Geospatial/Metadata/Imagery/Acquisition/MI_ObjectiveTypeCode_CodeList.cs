...
namespace NDSH.Geospatial.Metadata.Imagery.Acquisition {
  ...
  public class MI_ObjectiveTypeCode_CodeList : CodeListValue_Type {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="MI_ObjectiveTypeCode_CodeList"/>.
    /// </summary>
    public MI_ObjectiveTypeCode_CodeList() {
      //_mi_ObjectiveTypeCode = default; // new CodeListValue_Type(); // WARNING: Set to the first member of the codelist.
    }
