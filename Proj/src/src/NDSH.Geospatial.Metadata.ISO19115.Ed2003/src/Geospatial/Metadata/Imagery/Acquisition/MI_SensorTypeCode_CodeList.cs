...
namespace NDSH.Geospatial.Metadata.Imagery.Acquisition {
  ...
  public class MI_SensorTypeCode_CodeList : CodeListValue_Type {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="MI_SensorTypeCode_CodeList"/>.
    /// </summary>
    public MI_SensorTypeCode_CodeList() {
      //_mi_SensorTypeCode = default; // new CodeListValue_Type(); // WARNING: Set to the first member of the codelist.
    }
