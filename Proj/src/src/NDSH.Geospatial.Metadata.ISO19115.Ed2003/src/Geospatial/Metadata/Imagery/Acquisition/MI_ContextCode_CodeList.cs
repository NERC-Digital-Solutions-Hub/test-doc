...
namespace NDSH.Geospatial.Metadata.Imagery.Acquisition {
  ...
  public class MI_ContextCode_CodeList : CodeListValue_Type {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="MI_ContextCode_CodeList"/>.
    /// </summary>
    public MI_ContextCode_CodeList() {
      //_mi_ContextCode = default; // new CodeListValue_Type(); // WARNING: Set to the first member of the codelist.
    }
