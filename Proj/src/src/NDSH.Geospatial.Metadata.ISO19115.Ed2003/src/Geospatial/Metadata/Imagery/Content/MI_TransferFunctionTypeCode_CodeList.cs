...
// ---------------------------------------------------------------------------------------------------------------------
// <xs:element name="MI_TransferFunctionTypeCode"
...
namespace NDSH.Geospatial.Metadata.Imagery.Content {
  ...
  public class MI_TransferFunctionTypeCode_CodeList : CodeListValue_Type {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="MI_TransferFunctionTypeCode_CodeList"/>.
    /// </summary>
    public MI_TransferFunctionTypeCode_CodeList() {
      //_mi_TransferFunctionTypeCode = default; //  new CodeListValue_Type(); // WARNING: Set to the first member of the codelist.
    }
