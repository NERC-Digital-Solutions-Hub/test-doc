...
namespace NDSH.Geospatial.Metadata.Imagery.Acquisition {
  ...
  public class MI_TriggerCode_CodeList : CodeListValue_Type {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="MI_TriggerCode_CodeList"/>.
    /// </summary>
    public MI_TriggerCode_CodeList() {
      //_mi_TriggerCode = default; // new CodeListValue_Type(); // WARNING: Set to the first member of the codelist.
    }
