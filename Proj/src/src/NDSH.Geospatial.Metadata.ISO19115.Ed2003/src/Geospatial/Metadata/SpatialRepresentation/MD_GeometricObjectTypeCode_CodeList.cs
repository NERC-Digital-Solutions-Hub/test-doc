...
namespace NDSH.Geospatial.Metadata.SpatialRepresentation {
  ...
  public class MD_GeometricObjectTypeCode_CodeList : CodeListValue_Type {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="MD_GeometricObjectTypeCode_CodeList"/>.
    /// </summary>
    public MD_GeometricObjectTypeCode_CodeList() {
      //_md_GeometricObjectTypeCode = default; //  new CodeListValue_Type(); // WARNING: Set to the first member of the codelist.
    }
