...
namespace NDSH.Geospatial.Metadata.Maintenance {
  ...
  public class MD_MaintenanceFrequencyCode_CodeList : CodeListValue_Type {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="MD_MaintenanceFrequencyCode_CodeList"/>.
    /// </summary>
    public MD_MaintenanceFrequencyCode_CodeList() {
      //_md_MaintenanceFrequencyCode = default; //  new CodeListValue_Type(); // WARNING: Set to the first member of the codelist.
    }
