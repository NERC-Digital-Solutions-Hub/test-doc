...
// History           : 30/03/2025, @gisvlasta - Removed RequiredAttribute and updated the documentation.
//                   : 31/03/2005, @gisvlasta - Renamed ICodeSpace to INullableCodeSpace.
...
namespace NDSH.Geospatial.Metadata {
  ...
  /// </summary>
  public interface INullableCodeSpace {
