...
namespace NDSH.Geospatial.Metadata.Citation {
  ...
  public class CI_DateTypeCode_CodeList : CodeListValue_Type {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="CI_DateTypeCode_CodeList"/>.
    /// </summary>
    public CI_DateTypeCode_CodeList() {
      //_ci_DateTypeCode = default; //  new CodeListValue_Type(); // WARNING: Set to the first member of the codelist.
    }
