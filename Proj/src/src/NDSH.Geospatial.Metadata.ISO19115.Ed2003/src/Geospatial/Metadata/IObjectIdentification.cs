...
namespace NDSH.Geospatial.Metadata {
  ...
  /// <remarks>
  ///   <para>
  ///     This interface extends both <see cref="INullableId"/> and <see cref="INullableUuid"/>, integrating
  ...
  ///         <see cref="INullableId.Id"/> and <see cref="INullableUuid.Uuid"/>.
  ///       </item>
  ///       <item>
  ...
  ///   </para>
  /// </remarks>
  public interface IObjectIdentification : INullableId, INullableUuid {
