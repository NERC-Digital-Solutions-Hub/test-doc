...
namespace NDSH.Geospatial.Metadata.Identification {
  ...
  public class MD_KeywordTypeCode_CodeList : CodeListValue_Type {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="MD_KeywordTypeCode_CodeList"/>.
    /// </summary>
    public MD_KeywordTypeCode_CodeList() {
      //_md_KeywordTypeCode = default; //  new CodeListValue_Type(); // WARNING: Set to the first member of the codelist.
    }
