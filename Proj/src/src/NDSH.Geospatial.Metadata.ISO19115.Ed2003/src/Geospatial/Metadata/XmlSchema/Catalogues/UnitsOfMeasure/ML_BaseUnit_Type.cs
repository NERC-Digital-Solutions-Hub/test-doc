...
namespace NDSH.Geospatial.Metadata.XmlSchema.Catalogues.UnitsOfMeasure {
  ...
  /// <summary>
  /// Respresents a multilingual unit of measure compliant with SI definitions.
  /// </summary>
  [Serializable]
  ...
  public class ML_BaseUnit_Type : BaseUnitType {
    ...
    /// <summary>
    /// Name, description, and attributes of unit of measure in a specified language different from the default language
    /// of the document.
    /// </summary>
