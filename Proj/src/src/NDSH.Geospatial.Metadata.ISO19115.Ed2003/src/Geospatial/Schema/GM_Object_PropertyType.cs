...
#region Header
// ---------------------------------------------------------------------------------------------------------------------
// Member of         : NDSH.Geospatial.Metadata.Common.SpatialSchema.csproj
...
namespace NDSH.Geospatial.Schema {

  // WARNING: ASAP

  /// <summary>
  /// Represents a property type that references a geometric object within a spatial schema.
  /// This class extends <see cref="ReferenceEntity"/> to support the association of
  ...
  ///     <b>Key Features:</b>
  ///     <list type="bullet">
  ///       <item>Extends <see cref="ReferenceEntity"/> to support spatial referencing.</item>
  ...
  // WARNING: Should this class inherit from ObjectReference_PropertyType ???
  public class GM_Object_PropertyType : ReferenceEntity {
