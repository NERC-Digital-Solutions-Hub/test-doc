...
using NDSH.Geospatial.Metadata.V2003.Thin.Features.Model;
...
namespace NDSH.Geospatial.Metadata.V2003.Thin.EntitySet {
  ...
  public class MD_Metadata_Type : AbstractObject_Type {
    ...
    public MD_Metadata_Type() {
      ...
      //_dateStamp = new ConceptualSchema.Primitive.DateTime.DateTime();
