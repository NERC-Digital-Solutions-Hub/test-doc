...
namespace NDSH.Geospatial.Metadata.V2003.Thin {
  ...
  public class TODO {
     ...
     * TODO: {Assembly Wide} If Boolean is Truth.Boolean then use the following using: using Boolean = NDSH.Geospatial.Metadata.V2003.Thin.ConceptualSchema.Primitive.Truth.Boolean;
