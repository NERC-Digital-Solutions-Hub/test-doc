...
namespace NDSH.Geospatial.Metadata.V2003.Thin.XmlSchema.Catalogues {
  ...
  public abstract class AbstractCT_Catalogue_Type : AbstractObject_Type {
    ...
    private List<CharacterString> _scope;
    ...
    public List<CharacterString> Scope {
      get {
        return _scope;
      }
      set {
    ...
    private List<CharacterString> _fieldOfApplication;
    ...
    public List<CharacterString> FieldOfApplication {
      get {
    ...
    private ConceptualSchema.Primitive.DateTime.DateTime _versionDate;
    ...
    public ConceptualSchema.Primitive.DateTime.DateTime VersionDate {
      get {
        return _versionDate;
      }
      set {
