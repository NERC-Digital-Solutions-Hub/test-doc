...
namespace NDSH.Geospatial.Demos.SearchAndMap.Blazor.Models {
  ...
  public sealed class ApplicationModel : Model {
    ...
    private string _arcGISApiKey;

    /// <summary>
    /// Gets/Sets the ArcGIS Online API Key.
    /// </summary>
    public string ArcGISApiKey {
      get {
        return _arcGISApiKey;
      }
      set {
        if (_arcGISApiKey != value) {
          _arcGISApiKey = value;
          OnPropertyChanged();
        }
      }
