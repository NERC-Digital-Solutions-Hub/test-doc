...
namespace NDSH.Geospatial.Metadata.V2005.DataQuality {
  ...
  public class DQ_NonQuantitativeAttributeAccuracy : EntityBase<DQ_NonQuantitativeAttributeAccuracy> {

    #region Constructors - Destructors

    /// <summary>
    /// Initialzies the <see cref="DQ_NonQuantitativeAttributeAccuracy"/>.
    /// </summary>
