...
namespace NDSH.Geospatial.Metadata.V2005.DataQuality {
  ...
  [JsonObject("DQ_LogicalConsistency")]
  public class DQ_LogicalConsistency : EntityBase<DQ_LogicalConsistency> {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="DQ_LogicalConsistency"/>.
    /// </summary>
    public DQ_LogicalConsistency() {
