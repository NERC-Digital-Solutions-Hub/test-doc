...
namespace NDSH.Geospatial.Metadata.V2005.DataQuality {
  ...
  public class DQ_ThematicClassificationCorrectness : EntityBase<DQ_ThematicClassificationCorrectness> {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="DQ_ThematicClassificationCorrectness"/>.
    /// </summary>
