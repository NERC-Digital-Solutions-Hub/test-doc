...
namespace NDSH.Geospatial.Metadata.V2005.DataQuality {
  ...
  public class DQ_RelativeInternalPositionalAccuracy : EntityBase<DQ_RelativeInternalPositionalAccuracy> {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="DQ_RelativeInternalPositionalAccuracy"/>.
    /// </summary>
