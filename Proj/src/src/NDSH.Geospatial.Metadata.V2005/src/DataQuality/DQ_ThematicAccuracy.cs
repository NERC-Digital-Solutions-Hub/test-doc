...
namespace NDSH.Geospatial.Metadata.V2005.DataQuality {
  ...
  [JsonObject("DQ_ThematicAccuracy")]
  public class DQ_ThematicAccuracy : EntityBase<DQ_ThematicAccuracy> {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="DQ_ThematicAccuracy"/>
    /// </summary>
    public DQ_ThematicAccuracy() {
