...
namespace NDSH.Geospatial.Metadata.V2005.DataQuality {
  ...
  public class DQ_AbsoluteExternalPositionalAccuracy : EntityBase<DQ_AbsoluteExternalPositionalAccuracy> {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes teh <see cref="DQ_AbsoluteExternalPositionalAccuracy"/>.
    /// </summary>
