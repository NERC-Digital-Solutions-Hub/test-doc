...
// Updated by        : 17/12/2022, 03:38, @gisvlasta - Cleaned Xml Serialization Attributes.
// Version           : 1.0.1
...
namespace NDSH.Geospatial.Metadata.V2005.Service {
  ...
  public class SV_OperationChainMetadata : Model {

    #region Constructors - Destructors

    /// <summary>
    /// Initializes the <see cref="SV_OperationChainMetadata"/>.
    /// </summary>
