...
// TODO: Update the comments to remove the Objectreference_PropertyType
...
namespace NDSH.Geospatial.Metadata.V2003.Common {
  ...
  ///     <see cref="IAssociation"/> and <see cref="IUuidRef"/>,
  ...
  ///       <item>Provides a UUID reference mechanism via <see cref="IUuidRef"/>.</item>
