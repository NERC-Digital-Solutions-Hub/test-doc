...
namespace NDSH.Geospatial.Demos.SearchAndMap.Commands {
  ...
  public sealed class SubmitQueryCommand : ICommand {
    ...
    public SubmitQueryCommand() {
      ...
      _encodingsDictionary.Add(Models.Services.MetadataSemanticSearch.Encoding.Ascii, System.Text.Encoding.ASCII);
      _encodingsDictionary.Add(Models.Services.MetadataSemanticSearch.Encoding.Unicode, System.Text.Encoding.Unicode);
      _encodingsDictionary.Add(Models.Services.MetadataSemanticSearch.Encoding.Utf7, System.Text.Encoding.UTF7);
      _encodingsDictionary.Add(Models.Services.MetadataSemanticSearch.Encoding.Utf8, System.Text.Encoding.UTF8);
      _encodingsDictionary.Add(Models.Services.MetadataSemanticSearch.Encoding.Utf32, System.Text.Encoding.UTF32);
    ...
    public void Execute(object? parameter) {
      ...
      try {
        ...
        if (_metadataDatabaseController == null) {
          GetAllBgsLayersFromDb(metadataSearchModel);
        }
    ...
    /// </summary>
    /// <param name="metadataSearchModel">The <see cref="MetadataSearchModel"/>.</param>
    private void GetAllBgsLayersFromDb(MetadataSearchModel metadataSearchModel) {
